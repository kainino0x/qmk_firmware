...
#define _OS_LAYOUT( \
      idx, nextdflt,  kc_cmd,         kc_foo,         cmd,            foo_T,          redo,           word,           back,           forward) \
  [idx] = LAYOUT(                                                                                                                                                                                                                     \
  ...
  [(idx) + 1] = LAYOUT(                                                                                                                                                                                                               \
      ...
      kc_foo,         XXXXXXX,        back,           KC_PGUP,        forward,        redo,                                           KC_MNXT,        KC_HOME,        KC_UP,          KC_END,         XXXXXXX,        KC_BSLS,        \
      KC_ESC,         cmd(KC_A),      word(KC_LEFT),  KC_PGDN,        word(KC_RGHT),  XXXXXXX,                                        KC_MPRV,        KC_LEFT,        KC_DOWN,        KC_RGHT,        XXXXXXX,        KC_EQL,         \
      KC_TRNS,        cmd(KC_SLSH),   cmd(KC_B),      cmd(KC_I),      cmd(KC_DOT),    KC_DEL,         DF(nextdflt),   DEBUG,          XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,        KC_INS,         \
                                                                      KC_TRNS,        KC_TRNS,        word(KC_BSPC),  KC_TAB,         KC_TRNS,        KC_TRNS)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  _OS_LAYOUT(0, 2,         KC_LCTL,      KC_LGUI,      LCTL,         LGUI_T,        LCTL(KC_T),       LCTL,           LALT(KC_LEFT),  LALT(KC_RIGHT)), // Win
  _OS_LAYOUT(2, 0,         KC_LGUI,      KC_LCTL,      LGUI,         LGUI_T,        SGUI(KC_SLSH),    LALT,           LGUI(KC_LEFT),  LGUI(KC_RIGHT)), // Mac
};
